function [imageNumber,message] = importOpencvAnalysisFile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [VARNAME1,DISCARDEDFLYWINGSARETOUCH] = IMPORTFILE(FILENAME) Reads data
%   from text file FILENAME for the default selection.
%
%   [VARNAME1,DISCARDEDFLYWINGSARETOUCH] = IMPORTFILE(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [VarName1,DISCARDEDFlywingsaretouch] =
%   importfile('OpenCVAnalysisResult.txt',1, 101);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2013/05/29 10:19:18
